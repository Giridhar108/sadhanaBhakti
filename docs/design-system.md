...
Дизайн-система для проекта **«Садхана Бхакти»** — базовые стили, токены и компоненты интерфейса. Этот документ собран по утверждённому экрану дизайн-системы и должен быть главным источником визуальных правил для новых экранов: Главная, Джапа, Чтение книг, Стихи, Календарь, Профиль и Достижения.
